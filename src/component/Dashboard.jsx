...
const Dashboard = () => {
  return (
    <div className='w-full h-full bg-[#141416] text-white p-6 flex flex-col gap-4'>
        ...
        <div className='md:w-full lg:w-[40%] text-white flex gap-4 bg-light_black p-6 rounded-md'>
          ...
          <div>
            <Progress strokeLinecap="butt" type="circle" percent={75}
              strokeColor={{
                '0%': '#7393FE', // Starting color
                '100%': '#7393FE', // Ending color
              }}
              style={{
                borderRadius: '10%', // Ensure it’s rounded
                // border: '5px solid blue' // Custom border style
              }}
            />
          </div>
